...
`)
  ...
  ** #فوائد نصائح | هل تعلم ** :video_game: 
...
**  ======:blossom:نــتــمــنــآ لــكــم آســتــمـــتــآع :blossom:======  **`)
     ...
     client.on("message", message => {
      if (message.content === "-help-g") {
       const embed = new Discord.RichEmbed() 
           .setColor("#FF00FF")
           .setFooter('By server KInG Rewardes  ')
           .setDescription(`**__أتمنى يعجبكم البوت يا أغلى ناس:revolving_hearts: __**`)
     message.author.sendEmbed(embed)
...
if (message.author.id !== '526864822348808193') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
message.channel.stopTyping()
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/EEkbMNH**")
...
const sWlc = {}
const premium = ['526864822348808193', '', '', '']
client.on('message', message => {
var prefix = "#";
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`#help | By ezookik`,"http://twitch.tv/S-F")
